...
//可纵向线性布局的scrollview
@interface DVLinearScrollView : TPKeyboardAvoidingScrollView <UITextViewDelegate, UIGestureRecognizerDelegate>
...
DVLinearScrollView* makeLinearScrollView(UIViewController* vc);//with autosize
DVLinearScrollView* makeSimpleLinearScrollView(UIViewController* vc); //no autosize
