...
-(void)setStringsColor:(UIColor *)stringsColor{
    objc_setAssociatedObject(self, @selector(stringsColor), stringsColor, OBJC_ASSOCIATION_ASSIGN);
}
...
- (void)yb_getRangesWithStrings:(NSArray <NSString *>  *)strings
{
    ...
    NSMutableAttributedString *aString = [[NSMutableAttributedString alloc]initWithString:totalStr];
    ...
    [strings enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if (range.length != 0) {
            ...
            [aString addAttribute:NSForegroundColorAttributeName value:HEXCOLOR(0x43bc68) range:range];
        }
